					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								...
								<div class="media-body">
									<span class="media-heading text-semibold">MD Shakil</span>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="{{ route('users.index') }}"><i class="icon-user-plus"></i> <span>Users</span></a></li>
								<li><a href="#"><i class="icon-user-plus"></i> <span>Blog</span></a></li>
								<li><a href="{{ route('blogCategory.index') }}"><i class="icon-user-plus"></i> <span>Blog Caregory</span></a></li>
								<!-- Main -->
